...
{
    vec2 pixelSubTexCoords = texCoord * subTexRes[layer];
    vec2 subTexCoords = pixelSubTexCoords / vec2(4096.0, 4096.0);
    vec4 textureColor = texture(texArray, vec3(subTexCoords, float(layer)));
