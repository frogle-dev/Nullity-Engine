...
void NullityEditor::UpdateEditor(State& editorState, Nullity::Data& engData, Nullity::State& engState, GLFWwindow* window)
{
    ...
    if (ImGui::BeginMainMenuBar())
    {
        if (ImGui::BeginMenu("Window"))
        {
            ...
            {
                editorState.demoWindow = !editorState.demoWindow;
            }
    ...
    InfoWindow(engState.msPerFrame, engState.fps);
    DebugOutputWindow();
    ...
    ImGui::Begin("Game");
    {
        ...
        editorState.framebuffer.Rescale(width, height);
        Nullity::WindowSizeCallback(window, width, height);

        ImGui::Image(
            (ImTextureID)editorState.framebuffer.GetColorTexture(), 
